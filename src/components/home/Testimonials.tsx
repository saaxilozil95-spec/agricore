          ...
          {marqueeItems.map((item, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#15803D] to-[#CA8A04] flex items-center justify-center text-white font-bold font-serif text-lg uppercase">
                  {item.name.charAt(0)}
                </div>
                <div>
